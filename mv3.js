...
//followed mustangv3 for most of the functions
function setStatus(status) {
    document.getElementById("statusID").innerHTML = status;    
}

function logContacts() {
    console.log("Contact Array Here ");
...
function saveContactsToServer() {
    console.log("Saving Contacts To Server");
...
function loadContactsFromServer() {
    console.log("Loading Contacts from the Server");
    contactArray.length = 0;
...
function viewCurrentContact() {
    ...
    document.getElementById("statusID").innerHTML = "Status: Contact  " + (currentContactIndex+1) + " of " + contactArray.length;
}
...
function zipCity() {
    ...
    console.log("function zipCity(zip) { ... }");
...
async function loadIndex() {
    ...
    } console.log("The Contact URL: " + JSON.stringify(contactURLArray));
}
